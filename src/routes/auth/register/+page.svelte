<script lang="ts">
	...
	function validateAndSubmit() {
		...
		const ok = !nameError && !emailError && !passwordError && !confirmError;
		if (ok) {
			// TODO: submit to API (no-op for now)
		}
	}
	...
	>
		...
		>
			<button
				slot="trailing"
				type="button"
				class="grid size-5 place-items-center rounded-[8px] text-[var(--color-black-300)] focus:outline-none focus-visible:ring-2 focus-visible:ring-black/20"
